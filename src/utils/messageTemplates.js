...
function getRandomMessages(count = 1, category = null) {
  const sourceArray = category ? messageCategories[category] || messageTemplates : messageTemplates;
...
function getMessageStats() {
  return {
    ...
    categoryBreakdown: Object.entries(messageCategories).reduce((acc, [key, value]) => {
